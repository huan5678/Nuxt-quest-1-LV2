...
<template>
  <div class="min-vh-100 bg-neutral-120">
    ...
    <div class="position-relative d-flex flex-column flex-md-row">
      <img class="d-none d-md-block position-relative z-1 min-vh-100 object-fit-cover"
           style="max-width: 50%;" src="@/assets/images/login-hero.png" alt="login-hero">

      <div
           class="d-flex flex-column justify-content-center align-items-center flex-grow-1 pt-18 pt-md-0">
        <picture class="w-100">
          <source srcset="@/assets/images/deco-line-group-horizontal.svg"
